...
COV_CARGO_ENV=('RUSTFLAGS=-Zinstrument-coverage -Clink-dead-code' 'RUSTDOCFLAGS=-Zinstrument-coverage -Clink-dead-code' 'CARGO_INCREMENTAL=0')

# https://rust-lang.github.io/rustup-components-history/
# rustup +nightly-2021-10-26 component add llvm-tools-preview
NIGHTLY_TOOLCHAIN=nightly-2021-10-26
